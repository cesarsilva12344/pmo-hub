...
export const ProjectDetails = {
    ...
    async renderList(projectId) {
        ...
        const statusLabels = { 'todo': 'A Fazer', 'in_progress': 'Em Andamento', 'review': 'Revisão', 'done': 'Concluído' };
        ...
        tbody.innerHTML = tasks.map(t => `
            <tr class="border-b hover:bg-slate-50">
                ...
                <td class="py-3 px-4 text-sm text-slate-500">${statusLabels[t.status] || t.status}</td>
